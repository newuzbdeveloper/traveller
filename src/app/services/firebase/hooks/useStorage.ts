...
interface Props {
  ...
  onSingleUploadSuccess: (index: number, uploadedFile: TripFile) => void;
}
...
export function useStorage({
  ...
  const uploadFiles = (path: string, files: (FilesToUpload | null)[]) => {
      ...
      uploadTask.on(
        ...
        () => {
          setState((prevState) => {
            ...
            onSingleUploadSuccess(index, newUploadedFiles[index]);
